...
*   Building AI-powered consumer tools that solve real problems — document analysis, photo transformation, and more
...
*   **[FinePrint](https://fineprint.web.app):** Snap a photo of any bill, contract, or notice and instantly get a plain-English breakdown with power questions to ask back. Privacy-first with manual PII redaction before upload.
    *   *Tech:* React PWA, Material UI, Python/FastAPI, Google Gemini Vision, Firebase Hosting, GCP Cloud Run
...
*   **[ArtSplash](https://github.com/jawnty/artsplash):** A fun drawing app for kids — drag and drop characters onto your canvas and draw your own backgrounds.
...
*   **[LinkedIn Analyzer](https://github.com/jawnty/li-analyzer):** Filter 1st-degree LinkedIn connections based on company market cap and estimated job seniority, identifying potential leads from CSV exports.
    *   *Tech:* Python, Pandas, Fuzzy Matching

### 🛠️ Technical Skills:

*   **Languages:** Python, JavaScript, TypeScript, Dart, Java, C++, Kotlin
*   **Frontend:** React, Flutter, Material UI, HTML Canvas, PWAs
*   **Backend:** FastAPI, Express, Node.js
*   **AI/ML:** Google Gemini, OpenAI, LLMs, Agentic Workflows, Vision APIs
*   **Cloud:** GCP (Cloud Run, Firestore, Firebase Hosting, App Distribution), Docker
*   **Concepts:** Distributed Systems, API Design, Test Driven Development, Agile
